...
<head>
    ...
    <title>Oyunbaz - Game & Gaming Landing Page HTML5 Template</title>
            ...
            <div class="carousel-actions">
                <div class="carousel-indicators">
                    ...
                    <div data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2">
                        <img class="carousel-img" src="src/assets/img/carousel/slider-3.jpg" alt="slider3">
                    </div>
                    <div data-bs-target="#carouselExampleIndicators" data-bs-slide-to="3">
                        <img class="carousel-img" src="src/assets/img/carousel/slider-4.jpg" alt="slider4">
                    </div>
                </div>
            </div>
            <div class="carousel-inner">
                    ...
                    <div class="carousel-container container">
                        <div class="carousel-caption">
                            <div class="carousel-ttl">
                                <h2 class="carousel-ttl_name">Carousel Slider Title #1</h2>
                            </div>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-container">
                        <div class="carousel-caption">
                            <div class="carousel-ttl">
                                <h2 class="carousel-ttl_name">Carousel Slider Title #2</h2>
                            </div>
                            <div class="carousel-txt">
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut et massa mi. Aliquam in
                ...
                <div class="carousel-item">
                    <img class="carousel-img" src="src/assets/img/carousel/slider-3.jpg" alt="slider1">
                    <div class="carousel-container">
                        <div class="carousel-caption">
                            <div class="carousel-ttl">
                                <h2 class="carousel-ttl_name">Carousel Slider Title #3</h2>
                            </div>
                            <div class="carousel-txt">
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut et massa mi. Aliquam in
                ...
                <div class="carousel-item">
                    <img class="carousel-img" src="src/assets/img/carousel/slider-4.jpg" alt="slider2">
                    <div class="carousel-container">
                        <div class="carousel-caption">
                            <div class="carousel-ttl">
                                <h2 class="carousel-ttl_name">Carousel Slider Title #4</h2>
                            </div>
                            <div class="carousel-txt">
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut et massa mi. Aliquam in
                            ...
                            <div class="container">
                                <div class="navbar-container">
                                    <a class="navbar-brand page-scroll" href="#home">
                                        ...
                                        <h2 class="navbar-brand_name">Oyunbaz</h2>
                                    </a>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-5">
                        <div class="feat-info">
                            ...
                            <p class="feat-info_text">Dolor minim in pariatur in deserunt laboris eu pariatur labore excepteur cupidatat cupidatat duis dolor in.<br>
                            Lorem ipsum dolor sitamet const adipiscng Duis eletum sollicitudin is yaugue euismods.</p>
                ...
                <div id="thumb-slider">
                    <div class="card shadow-sm">
                        <div class="card-image">
                            <img src="src/assets/img/thumb/games-1.jpg" alt="game1">
                        ...
                        <div class="card-body">
                            ...
                            <div class="ch-prize">
                                ...
                                <div class="ch-prize_desc">
                                    ...
                                    <p class="ch-prize_text">Lorem ipsum dolor sitamet const adipiscng</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-image">
                            <img src="src/assets/img/thumb/games-2.jpg" alt="game2">
                            <div class="card-image_over">
                                <div class="card-time">
                                    <i class="icon-clock"></i>
                        ...
                        <div class="card-body">
                            <h3 class="card-title">Challenge #2</h3>
                            <div class="line-x"></div>
                            <div class="ch-obj">
                                <h4 class="ch-obj_ttl">Objective</h4>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-image">
                            <img src="src/assets/img/thumb/games-3.jpg" alt="game3">
                            <div class="card-image_over">
                                <div class="card-time">
                                    <i class="icon-clock"></i>
                                    <span>Ends in 2 Days</span>
                        ...
                        <div class="card-body">
                            <h3 class="card-title">Challenge #3</h3>
                            <div class="line-x"></div>
                            <div class="ch-obj">
                                <h4 class="ch-obj_ttl">Objective</h4>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-image">
                            <img src="src/assets/img/thumb/games-4.jpg" alt="game4">
                            <div class="card-image_over">
                                <div class="card-time">
                                    <i class="icon-clock"></i>
                        ...
                        <div class="card-body">
                            <h3 class="card-title">Challenge #4</h3>
                            <div class="line-x"></div>
                            <div class="ch-obj">
                                <h4 class="ch-obj_ttl">Objective</h4>
                                <p class="ch-obj_text">Get a triple kill in a game</p>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-image">
                            <img src="src/assets/img/thumb/games-5.jpg" alt="game1">
                            <div class="card-image_over">
                                <div class="card-time">
                                    <i class="icon-clock"></i>
                                    <span>Ends in 2 Days</span>
                        ...
                        <div class="card-body">
                            <h3 class="card-title">Challenge #5</h3>
                            <div class="line-x"></div>
                            <div class="ch-obj">
                                <h4 class="ch-obj_ttl">Objective</h4>
                                <p class="ch-obj_text">Get or assist the first kill in the game.</p>
                ...
                <div class="card about-card parallax">
                    <div class="row">
                        <div class="col-md-12 col-lg-5">
                            ...
                            <p class="about-text">
                                Dolor minim in pariatur in deserunt laboris eu pariatur labore excepteur cupidatat cupidatat duis dolor in. <br><br>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="gcard-desc">
                            ...
                            <p class="gcard-note">Lorem ipsum dolor sitamet const adipiscng Duis eletum sollicitudin is yaugue euismods.</p>
                        </div>
                    </div>
                    <div class="col-md-8">
                                ...
                                <div class="gcard_details">
                                    <div class="gcard-bottom">
                                        <div class="gcard-rating">Rating: <span><i class="icon-star-full"></i>
                                                4,6</span></div>
                                        <h4 class="gcard-title">Game #1</h4>
                            ...
                            <a href="" class="gcard-item">
                                ...
                                <div class="gcard_details">
                                    <div class="gcard-bottom">
                                        <div class="gcard-rating">Rating: <span><i class="icon-star-full"></i>
                                                3,9</span></div>
                                        <h4 class="gcard-title">Game #2</h4>
                            ...
                            <a href="" class="gcard-item">
                                ...
                                <div class="gcard_details">
                                    <div class="gcard-bottom">
                                        <div class="gcard-rating">Rating: <span><i class="icon-star-full"></i>
                                                4,8</span></div>
                                        <h4 class="gcard-title">Game #3</h4>
                            ...
                            <a href="" class="gcard-item">
                                ...
                                <div class="gcard_details">
                                    <div class="gcard-bottom">
                                        <div class="gcard-rating">Rating: <span><i class="icon-star-full"></i>
                                                4,5</span></div>
                                        <h4 class="gcard-title">Game #4</h4>
                                        <div class="gcard-catg">Battle Royale</div>
                                        <div class="gcard-stats">
                                            <div class="gcard-stats_col">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <p class="contact-text">Lorem ipsum dolor sitamet const adipiscng</p>
                        </div>
                        <div class="col-md-8 contact-list">
                            <p class="contact-item"><strong>Office: </strong>Your City, Your streert, <br> Your Avenue, Postal Code</p>
                            <p class="contact-item"><strong>Email: </strong>info@companyname.com</p>
                            <p class="contact-item"><strong>Phone Number: </strong>(+91) 123 456 789 0</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <p class="ftext">
                                Dolor minim in pariatur in deserunt laboris eu pariatur labore excepteur cupidatat cupidatat duis dolor in. <br>
                                Lorem ipsum dolor sitamet const adipiscng Duis eletum sollicitudin is yaugue euismods.
                            </p>
                    ...
                    <div class="fcopy">
                        <p class="fcopy-info">Copyright © 2023 Oyunbaz - All rights reserved.</p>
                        <div class="fcopy-nav">
